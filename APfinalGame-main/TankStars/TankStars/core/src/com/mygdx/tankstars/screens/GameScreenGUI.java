...
class Tank extends GameElements{
    ...
    public void fire(int turn,Tank t) throws InterruptedException {
        ...
        if(turn==1){
           ...
           while(i>0){
               //this.getCurrentweapon().generateTrajectoryY(i-55) < Ground.generateY(i)-100
...
//
//            shape.rect(900, 550,40, 50);
//            shape.end();

        game.batch.begin();
//        if (flag == 2) {
//            game.batch.draw(tank2wins, 0, 0);
//            if (Gdx.input.justTouched()) {
//                game.setScreen(new HomePageGUI(game));
//
//            }
//        } else if (flag == 1) {
//            game.batch.draw(tank1wins, 0, 0);
//            if (Gdx.input.justTouched()) {
//                game.setScreen(new HomePageGUI(game));
//
//            }
...
//        game.batch.draw(dot,l.getX()+10,100);
        ...
        if (r.getHealth()==0)
        {
            game.batch.draw(tank1wins, -90, -90);
            System.out.println("Tank 1 Wins!!");
            game.setScreen(game.homepg);
            //System.out.println("DONE");
//            if (Gdx.input.justTouched()) {
//                System.out.println("Setting new homepage");
//                game.batch.end();
//                game.setScreen(game.homepg);
...
//            }
        ...
        if (l.getHealth()==0)
        {
            game.batch.draw(tank2wins, -90, -90);
        ...
        if (turn == 1) {
            ...
            if (Gdx.input.isKeyJustPressed(Input.Keys.SPACE)) {
                ...
                try {
                    ...
                    if (l.getHealth() == 0) {
                        flag = 2;
                        //System.out.println("Tank2 Wins! Game Over!");
